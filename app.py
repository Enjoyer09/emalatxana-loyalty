...
# ==========================================================
# 💾 BÜTÜN SESSIYA STATE-LƏRİ (ORİJİNAL 244 STR STRUKTURU)
# ==========================================================
if 'logged_in' not in st.session_state: st.session_state.logged_in = False
if 'session_token' not in st.session_state: st.session_state.session_token = None
if 'multi_carts' not in st.session_state: 
    st.session_state.multi_carts = {1: {'cart': [], 'customer': None}, 2: {'cart': [], 'customer': None}, 3: {'cart': [], 'customer': None}}
...
# --- SƏNİN ORİJİNAL GENİŞ METALLİK CSS BLOKUN (TAM ŞƏKİLDƏ) ---
st.markdown("""
    <style>
    ...
    div[role="radiogroup"] > label { 
        ...
        padding: 10px 20px !important; cursor: pointer; box-shadow: 4px 4px 8px rgba(0,0,0,0.6) !important; transition: all 0.2s;
    }
    div[role="radiogroup"] label:has(input:checked) { 
        background: var(--accent-gold) !important; border: 2px solid #ffffff !important; 
        box-shadow: 0 0 20px rgba(255, 215, 0, 0.8) !important; transform: scale(1.08) !important;
    }
...
# LOGIN MƏNTİQİ (HİSSƏ-HİSSƏ AÇILMIŞ STRUKTUR)
...
if not st.session_state.logged_in:
    ...
    if role in ['admin', 'manager']:
        tabs_list.extend(["💰 Maliyyə", "📦 Anbar", "📊 Analitika", "🤖 AI Menecer", "📋 Menyu", "📜 Resept", "⚙️ Ayarlar", "💾 Baza", "QR", "🕵️ Loglar", "📝 Qeydlər"])
