...
# ==========================================
# === EMALATKHANA POS - V6.76 (Z-REPORT MOVED UP) ===
# ==========================================

VERSION = "v6.76 (Fixed: Z-Report Location, Search Input Reset)"
...
# --- FIX FOR SEARCH INPUT STATE ERROR ---
...
if not st.session_state.logged_in:
    ...
    if role in ['staff', 'manager', 'admin']: tabs_list.append("📊 Z-Hesabat") # --- MOVED UP ---
