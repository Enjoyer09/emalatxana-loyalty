    ...
    if not df.empty:
        ...
        if not user['is_active']:
            ...
            with st.form("act"):
                ...
                with st.expander("📜 Qaydalar"):
                    st.markdown(f"""**{SHOP_NAME} Qaydaları:** 9 ulduz = 1 Hədiyyə. Ad günü hədiyyəsi üçün şəxsiyyət vəsiqəsi lazımdır.""")
                    ...
                    if cnt == 1:
                        ...
                        with zipfile.ZipFile(z, "w") as zf:
                            for i in ids: 
                                ...
                                d = generate_custom_qr(f"{APP_URL}/?id={i}&t={tkn}", i)
