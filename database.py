    ...
    with conn.session as s:
        ...
        s.execute(text("""
            CREATE TABLE IF NOT EXISTS users (
                ...
                last_seen TIMESTAMP, failed_attempts INTEGER DEFAULT 0, locked_until TIMESTAMP
            );
        """))
        ...
        s.execute(text("""
            CREATE TABLE IF NOT EXISTS active_sessions (
                ...
                created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, last_activity TIMESTAMP
            );
        """))

        s.execute(text("""
            CREATE TABLE IF NOT EXISTS tables (
                id SERIAL PRIMARY KEY, label TEXT, is_occupied BOOLEAN DEFAULT FALSE,
                items TEXT, total DECIMAL(10,2) DEFAULT 0, opened_at TIMESTAMP
            );
        """))

        s.execute(text("""
            CREATE TABLE IF NOT EXISTS menu (
                id SERIAL PRIMARY KEY, item_name TEXT, price DECIMAL(10,2),
                category TEXT, is_active BOOLEAN DEFAULT FALSE, is_coffee BOOLEAN DEFAULT FALSE,
                printer_target TEXT DEFAULT 'kitchen', price_half DECIMAL(10,2)
            );
        """))

        s.execute(text("""
            CREATE TABLE IF NOT EXISTS sales (
                id SERIAL PRIMARY KEY, items TEXT, total DECIMAL(10,2),
                payment_method TEXT, cashier TEXT, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
                ...
                cogs DECIMAL(10,2) DEFAULT 0, bank_fee DECIMAL(10,2) DEFAULT 0,
        ...
        s.execute(text("""
            CREATE TABLE IF NOT EXISTS finance (
                ...
                created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, subject TEXT,
        ...
        s.execute(text("""
            CREATE TABLE IF NOT EXISTS finance_audit_log (
                id SERIAL PRIMARY KEY, original_id INTEGER, action TEXT,
                original_data TEXT, new_data TEXT, performed_by TEXT,
                reason TEXT, performed_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
            );
        """))
        ...
        s.execute(text("""
            CREATE TABLE IF NOT EXISTS logs (
                ...
                details TEXT, ip TEXT, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
            );
        """))

        s.execute(text("""
            CREATE TABLE IF NOT EXISTS z_reports (
                id SERIAL PRIMARY KEY, total_sales DECIMAL(10,2),
                cash_sales DECIMAL(10,2), card_sales DECIMAL(10,2),
                total_cogs DECIMAL(10,2), actual_cash DECIMAL(10,2),
        ...
        s.execute(text("""
            CREATE TABLE IF NOT EXISTS shift_handovers (
                id SERIAL PRIMARY KEY, handed_by TEXT,
                expected_cash DECIMAL(10,2), actual_cash DECIMAL(10,2),
        ...
        s.execute(text("""
            CREATE TABLE IF NOT EXISTS correction_requests (
                id SERIAL PRIMARY KEY, requested_by TEXT,
                cash_diff DECIMAL(10,2), card_diff DECIMAL(10,2),
