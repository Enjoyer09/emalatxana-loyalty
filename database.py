...
def ensure_schema():
    ...
    with conn.session as s:
        ...
        # BİZİM YENİ ƏLAVƏ ETDİYİMİZ KAMPANİYALAR CƏDVƏLİ
        s.execute(text("CREATE TABLE IF NOT EXISTS campaigns (id SERIAL PRIMARY KEY, title TEXT, description TEXT, img_url TEXT, badge TEXT, is_active BOOLEAN DEFAULT TRUE);"))
